...
using AsterismWay.IdentityServer.Helpers;
    ...
    public class IdentityController : ControllerBase
    {
        ...
        public async Task<ActionResult> Create(CreateUserRequestModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var mailMessage = new MailMessage
                {
                    ...
                    Body = $"Ви отримали цей електронний лист, оскільки для вас було створено акаунт у застосунку Asterism.<br/><br/>" +
                    $"Будь ласка, налаштуйте свій пароль <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>перейшовши за посиланням</a>.<br/><br/>" +
                    $"Якщо у вас виникли труднощі, зверніться до служби підтримки Asterism за адресою <a href='mailto:support@asterism.com'>" +
                    $"support@asterism.com</a><br/><br/><span style='font-size:13px;font-style:italic'>" +
        ...
        public async Task<ActionResult<string>> ConfirmEmail(PasswordResetSendEmailModel model)
        {
            ...
            var mailMessage = new MailMessage
            {
                ...
                Body = $"Ви отримали цей електронний лист, оскільки ваш пароль до Asterism було скинуто.<br/><br/>" +
